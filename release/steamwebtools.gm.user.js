				...
				run: function () {
						...
						function () {
							...
							if (i) {
								...
								links = [{
										...
										href: "http://www.steamprices.com/" + _cc.curCC.toLowerCase() + "/" + n + "/" + o,
										icon: "https://www.steamprices.com/assets/images/favicons/favicon-16x16.png?v=a",
										text: v("viewin") + " SteamPrices.com"
									}, {
										href: "http://plati.com/asp/find.asp?ai=111350&searchstr=" + p,
										icon: "http://plati.com/favicon.ico",
										text: v("searchin") + " Plati.com"
									}, {
										href: "http://www.steamgifts.com/giveaways/search?q=" + p,
								...
								u = g({
										...
										[n]).wrap(g('<a href="#viewlogos" title="View Logos"></a>').click(function () {
											for (var e = ["capsule_616x353", "header", "header_586x192", "header_292x136", "capsule_231x87", "capsule_184x69", "capsule_sm_120"], t = "", a = 0; a < e.length; a++)
												t += '<img src="http://cdn.akamai.steamstatic.com/steam/' + n + "s/" + o + "/" + e[a] + '.jpg"><br>';
					...
					run: function () {
						...
						f.g_rgProfileData && function () {
							...
							try {
								var t = h('.profile_header_actions>a.btn_profile_action[href^="javascript:LaunchWebChat"]')[0];
						...
						if (f.g_strInventoryLoadURL) {
							...
							!function () {
								...
								if (f.getSubid = function (e) {
									...
									new f.Ajax.Request("https://steamcommunity.com/gifts/" + i.giftId + "/validateunpack", {
										method: "post",
										parameters: {
											sessionid: f.g_sessionID
										},
					...
					run: function () {
						...
						if (n(".gamecards_inventorylink").append('<a class="btn_grey_grey btn_small_thin" href="http://www.steamcardexchange.net/index.php?inventorygame-appid-' + e + '"><span>www.SteamCardExchange.net</span></a> '), n(".badge_craft_button").length) {
					...
					run: function () {
						...
						r(".grouppage_logo>img")[0].src = "http://v1t.su/projects/steam/webtools/imgs/steam-big-icon.png",
						...
						r(".grouppage_join_area a")[0].href = "http://v1t.su/projects/steam/webtools/",
